...
$c_Lcalculator_Calculator$.prototype.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D = (function(iExpr, stackVars, references$1) {
  _internalEval: while (true) {
    var x1 = iExpr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      var this$1 = stackVars;
      if ($s_sc_LinearSeqOptimized$class__contains__sc_LinearSeqOptimized__O__Z(this$1, name)) {
        return (NaN)
      } else {
        var refExpr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references$1);
        var this$2 = stackVars;
        var temp$stackVars = new $c_sci_$colon$colon().init___O__sci_List(name, this$2);
        iExpr = refExpr;
        stackVars = temp$stackVars;
        continue _internalEval
      }
    } else if ($is_Lcalculator_Plus(x1)) {
      var x4 = $as_Lcalculator_Plus(x1);
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(a, stackVars, references$1) + this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(b, stackVars, references$1))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(a$2, stackVars, references$1) - this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(b$2, stackVars, references$1))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(a$3, stackVars, references$1) * this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(b$3, stackVars, references$1))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(a$4, stackVars, references$1) / this.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(b$4, stackVars, references$1))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      if ((d < 0)) {
        ...
        var array = [(((-jsx$1) + $uD($g.Math.sqrt(x))) / (2 * $uD(a$2.apply__O())))];
        ...
        var jsx$5 = $uD($g.Math.sqrt(x$1));
        var jsx$4 = $uD(a$2.apply__O());
        var jsx$3 = $uD(b$2.apply__O());
        var x$2 = $uD(delta$1.apply__O());
        var array$1 = [(((-jsx$6) + jsx$5) / (2 * jsx$4)), (((-jsx$3) - $uD($g.Math.sqrt(x$2))) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var v = $uI(remainingCharsCount$1.apply__O());
      return ((v < 0) ? "red" : ((v < 15) ? "orange" : "green"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__sci_Map__T2__sci_Map = (function(map, pair) {
  var jsx$1 = pair.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, pair$1) {
    return (function() {
      var this$1 = $m_Lcalculator_Calculator$();
      var expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(pair$1.$$und2$f).apply__O());
      var references = arg$outer.namedExpressions$1$f;
      return this$1.internalEval$1__p1__Lcalculator_Expr__sci_List__sci_Map__D(expr, $m_sci_Nil$(), references)
    })
  })(this, pair));
  return map.updated__O__O__sci_Map(jsx$1, new $c_Lcalculator_Signal().init___F0(expr$1))
});
